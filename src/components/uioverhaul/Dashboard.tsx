...
import { UniversityCourse, AppStage, CareerPath } from './types';
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between px-1">
                                ...
                                <span className="text-[10px] text-gray-600">Active Tasks</span>
                            </div>
                            ...
                            <div className="bg-surface border border-white/5 rounded-xl p-1.5 grid grid-cols-3 gap-1.5 shadow-lg">
                                ...
                                <button className="bg-white/5 border border-white/5 rounded-lg p-2 flex flex-col items-center justify-center text-center opacity-50 cursor-not-allowed">
                                    ...
                                    <span className="text-[9px] text-gray-600 font-mono"><Lock size={8} className="inline mr-0.5" /> Phase 2</span>
                                </button>
                                ...
                                <button className="bg-white/5 border border-white/5 rounded-lg p-2 flex flex-col items-center justify-center text-center opacity-50 cursor-not-allowed">
                                    ...
                                    <span className="text-[9px] text-gray-600 font-mono"><Lock size={8} className="inline mr-0.5" /> Phase 3</span>
                                </button>
                            </div>
                        </div>
