                ...
                <div className="p-6 flex flex-col justify-between bg-gradient-to-b from-white/[0.02] to-transparent relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center justify-between mb-3">
                            <span className={`px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded border ${profile.tier === 'Foundation' ? 'bg-slate-800/50 border-slate-600 text-slate-300' :
                    ...
                    <div className="relative z-10 flex flex-col items-center w-full h-full p-6 justify-between">
                        ...
                        <div className="w-full flex justify-between items-start">
                            <div className="flex flex-col">
                                <span className="text-[10px] text-gray-500 font-bold uppercase tracking-[0.2em]">Faculty</span>
                        ...
                        <div className="text-center w-full">
                            <div className="uppercase tracking-[0.3em] text-[9px] text-gray-500 mb-1 font-bold">Archetype Identified</div>
                ...
                <div className="flex flex-col bg-[#0A0C12] h-full min-h-[280px] relative group/radar overflow-hidden">
                    ...
                    <div className="px-5 py-3 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
                        <div className="flex items-center space-x-2 text-indigo-400">
                            <Activity size={12} />
                            <span className="text-[10px] font-bold uppercase tracking-widest">Trait Profile</span>
                        </div>
