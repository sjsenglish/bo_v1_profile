...
const VibeSwiper: React.FC<VibeSwiperProps> = ({ pairs, onComplete }) => {
    ...
    // Guard clause for when all pairs are exhausted
    if (!currentPair) {
        return null;
    }
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div className="w-full md:w-1/2">
                            <OptionCard option={currentPair.optionA} onClick={() => handleSelect('A')} />
                        </div>
                        ...
                        {/* Option B */}
                        <div className="w-full md:w-1/2">
                            <OptionCard option={currentPair.optionB} onClick={() => handleSelect('B')} />
                        </div>
